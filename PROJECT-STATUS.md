...
| Public policy documentation | Current pre-alpha baseline exists | The [AI disclosure](docs/policy/ai-content-disclosure.md), [terms](docs/policy/terms-baseline.md), and [moderation](docs/policy/moderation-policy.md) documents are aligned with current requirements and design contracts. Fresh owner acceptance of the remediated policy-file version is pending on PR #64. Runtime evidence remains split across #4/#6/#11/#12/#13/#15/#16/#37/#54: #4/#13 own report lifecycle, #11/#12 own video review transitions, #6/#13/#37 own moderation actions, #15 owns public metadata filtering, and #54 owns public media-route denial. Counsel and release approval remain separate launch gates. |
