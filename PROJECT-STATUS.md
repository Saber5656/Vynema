...
| Public policy documentation | Current pre-alpha baseline exists | The [AI disclosure](docs/policy/ai-content-disclosure.md), [terms](docs/policy/terms-baseline.md), and [moderation](docs/policy/moderation-policy.md) documents are aligned with current requirements and design contracts. Runtime evidence remains with #4/#13/#15/#16; counsel and release approval remain separate launch gates. |
