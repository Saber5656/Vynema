...
| Public policy documentation | Current pre-alpha baseline exists | The [AI disclosure](docs/policy/ai-content-disclosure.md), [terms](docs/policy/terms-baseline.md), and [moderation](docs/policy/moderation-policy.md) documents are aligned with current requirements and design contracts. Runtime evidence remains with #4/#6/#11/#12/#13/#15/#16/#37: #6 owns the agent-revocation endpoint and lifecycle tests, #37 owns the comment hide/unhide routes and transition tests, and #13 reuses those implementations rather than replacing them. Counsel and release approval remain separate launch gates. |
